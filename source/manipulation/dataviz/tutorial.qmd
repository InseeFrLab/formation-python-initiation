...
Pour les mêmes graphiques que ceux réalisés précédemment avec Pandas, Seaborn offre des représentations beaucoup plus agréables à l'oeil. On en présente quelques unes dans la suite de ce tutoriel. La [gallerie](https://seaborn.pydata.org/examples/index.html) d'exexemples de Seaborn illustre de nombreuses possibilités selon les données et les problématiques étudiées.
