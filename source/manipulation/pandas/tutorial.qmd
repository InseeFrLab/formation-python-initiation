...
```{python}
# Exécuter cette cellule pour afficher la solution
%load -r 285-289 solutions.py
```

#### Partie 4 : Calcul d'une empreinte carbone par habitant pour chaque commune

- Joindre les deux DataFrame à l'aide de la fonction à partir du code commune. Attention : les variables ne s'appellent pas de la même manière des deux côtés !
...
```{python}
# Exécuter cette cellule pour afficher la solution
%load -r 297-301 solutions.py
```

### Exercice : Analyse de l'évolution d'un indice de production
