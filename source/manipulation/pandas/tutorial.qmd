...
- Importez les données dans un DataFrame.
...
- Créez une fonction qui, pour un prénom donné, affihce l'année où il a été le plus donné ainsi que le nombre de fois où il a été donné cette année-là.
- Identifier le prénom le plus donné par décennie, pour chaque sexe.
...
### Exercice : méthode chaining

Le chaînage de méthodes permet de combiner plusieurs opérations en une seule
