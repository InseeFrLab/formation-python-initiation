...
df_prenoms = df_prenoms.with_columns(pl.col("preusuel").str.replace('_PRENOMS_RARES', None))
```
...
df_prenoms = df_prenoms.with_columns(pl.col("annais").str.replace("XXXX", None))
```
