...
Pour approfondir l'approche plus algorithmique du code, l'[Advent of Code](https://adventofcode.com/) propose chaque mois de Décembre 25 exercices sous forme d'énigmes en deux parties, qui impliquent une résolution algorithmique qui peut être effectuée en `Python`. Attention : si les premiers jours restent accessibles, la difficulté des énigmes devient rapidement très élevé.
