...
- pour des **projets internes à l'Insee**, l'utilisation de [`LS3`](https://datascience.gitlab-pages.insee.fr/site-documentaire/ls3/ls3-c-est-quoi/) (la version interne du `SSPcloud` pour le dire rapidement) est à privilégier.  même s'il est aussi possible d'utiliser Python directement depuis AUS (se référer à la [documentation](https://datascience.gitlab-pages.insee.fr/site-documentaire/ausv3/logiciels-carte/eco-systeme-python/) ;
